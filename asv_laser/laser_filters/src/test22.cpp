...
double lower_angle_ = -1.30;
double upper_angle_ = 4.98;
...
int main(int argc, char** argv){
  ros::init(argc, argv, "asv_laser2_filter_node");
  ros::NodeHandle n1, n2;
  input_scan_sub = n1.subscribe("/scan2", 10, input_scan_sub_callback);
  filtered_scan_pub = n2.advertise<sensor_msgs::LaserScan>("scan2_filtered", 50);
